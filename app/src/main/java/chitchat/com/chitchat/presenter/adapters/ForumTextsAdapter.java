...
public class ForumTextsAdapter extends RecyclerView.Adapter<ForumTextsAdapter.ViewHolder> {
    private Context mContext;
    private List<ForumTextsModel> forumTextsModelList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ForumTextsModel forumTextsModel = forumTextsModelList.get(position);
        holder.itemView.setTag(forumTextsModel);
        holder.bind(forumTextsModel);
    }

    public static class ViewHolder extends RecyclerView.ViewHolder{
        private ImageView userImage;
        private TextView userName, messageTime,message;

        public ViewHolder(View itemView) {
            super(itemView);
        }

        public void bind(ForumTextsModel forumTextsModel){
    ...
    public int getItemCount() {
        return forumTextsModelList.size();
    }
